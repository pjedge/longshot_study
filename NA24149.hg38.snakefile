...
rule plot_pr_curve_NA24149_hg38:
    ...
    input:
        reaper32_rtg = 'data/NA24149.hg38/vcfeval/reaper.filtered.pacbio.blasr.32x.-z/{chrom}.done',
    ...
    run:
        ptf.plot_vcfeval(['data/NA24149.hg38/vcfeval/illumina_30x.filtered/{}'.format(wildcards.chrom),
                                   'data/NA24149.hg38/vcfeval/reaper.filtered.pacbio.blasr.32x.-z/{}'.format(wildcards.chrom)],
