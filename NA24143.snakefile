...
NA24143_PACBIO_BAM_URL = 'ftp://ftp-trace.ncbi.nlm.nih.gov/giab/ftp/data/AshkenazimTrio/HG004_NA24143_mother/PacBio_MtSinai_NIST/Baylor_NGMLR_bam_GRCh37/all_reads.fa.giab_h004_ngmlr-0.2.3_mapped.bam'
...
rule plot_pr_curve_NA24143:
    ...
    input:
        reaper70_rtg = 'data/NA24143/vcfeval/reaper_30x.-z_-C_52/{chrom}.done',
    ...
    run:
        plot_vcfeval.plot_vcfeval(['data/NA24143/vcfeval/illumina_60x.filtered/{}'.format(wildcards.chrom),
                                   'data/NA24143/vcfeval/reaper_30x.-z_-C_52/{}'.format(wildcards.chrom)],
...
rule download_pacbio_NA24143:
    ...
    output: bam = 'data/NA24143/aligned_reads/pacbio/pacbio.30x.bam',
