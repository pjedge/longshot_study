...
rule make_four_genomes_table:
    ...
    input:
        NA12878_vcfeval_dir = 'data/NA12878/vcfeval/reaper.pacbio.blasr.44x.-z/{chrom}',
        ...
        NA12878_runtime = 'data/NA12878/variants/reaper.pacbio.blasr.44x.-z/{chrom}.GQ{GQ}.vcf.runtime',
        NA24385_vcfeval_dir = 'data/NA24385/vcfeval/reaper.pacbio.ngmlr.69x.-z/{chrom}',
        ...
        NA24385_runtime = 'data/NA24385/variants/reaper.pacbio.ngmlr.69x.-z/{chrom}.GQ{GQ}.vcf.runtime',
        NA24149_vcfeval_dir = 'data/NA24149/vcfeval/reaper.pacbio.ngmlr.32x.-z/{chrom}',
        ...
        NA24149_runtime = 'data/NA24149/variants/reaper.pacbio.ngmlr.32x.-z/{chrom}.GQ{GQ}.vcf.runtime',
        NA24143_vcfeval_dir = 'data/NA24143/vcfeval/reaper.pacbio.ngmlr.30x.-z/{chrom}',
        ...
        NA24143_runtime = 'data/NA24143/variants/reaper.pacbio.ngmlr.30x.-z/{chrom}.GQ{GQ}.vcf.runtime',
    output:
...
rule filter_vcf_outside_GIAB:
    ...
    input:  vcf = 'data/{dataset}/variants/{calls_name}/{chrom}.vcf.gz',
            region_filter ='data/{dataset}/variants/ground_truth/region_filter.bed'
    output: vcf = 'data/{dataset}/variants/{calls_name}/{chrom}.outside_GIAB.GQ{GQ}.vcf.gz',
    shell: '{RTGTOOLS} RTG_MEM=12g vcffilter --exclude-bed={input.region_filter} -g {GQ} --no-index -i {input.vcfgz} -o {output.vcfgz}'

rule filter_vcf_GQ:
    params: job_name = 'filter_vcf_GQ.{dataset}.{calls_name}.{chrom}.GQ{GQ}'
    input:  vcf = 'data/{dataset}/variants/{calls_name}/{chrom}.vcf.gz'
    output: vcf = 'data/{dataset}/variants/{calls_name}/{chrom}.GQ{GQ}.vcf.gz',
    shell: '{RTGTOOLS} RTG_MEM=12g vcffilter --exclude-bed={input.region_filter} -g {GQ} --no-index -i {input.vcfgz} -o {output.vcfgz}'
...
rule plot_simulation_pr_bars:
    ...
    run:
        ptf.plot_precision_recall_bars(
