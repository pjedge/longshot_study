...
rule rename_pacbio_NA24385_hg38:
    params: job_name = 'rename_pacbio_NA24385.hg38.minimap2'
    input: bam = 'data/NA24385.hg38/aligned_reads/pacbio/pacbio.minimap2.all.giab_full_coverage.bam'
    output: bam = 'data/NA24385.hg38/aligned_reads/pacbio/pacbio.minimap2.all.69x.bam',
