...
rule plot_pr_curve_NA24385:
    ...
    input:
        reaper20_rtg = 'data/NA24385/vcfeval/reaper.pacbio.ngmlr.20x.-z/{chrom}.done',
        reaper30_rtg = 'data/NA24385/vcfeval/reaper.pacbio.ngmlr.30x.-z/{chrom}.done',
        reaper40_rtg = 'data/NA24385/vcfeval/reaper.pacbio.ngmlr.40x.-z/{chrom}.done',
        reaper50_rtg = 'data/NA24385/vcfeval/reaper.pacbio.ngmlr.50x.-z/{chrom}.done',
        reaper69_rtg = 'data/NA24385/vcfeval/reaper.pacbio.ngmlr.69x.-z/{chrom}.done',
        illumina_rtg = 'data/NA24385/vcfeval/illumina_60x.filtered/{chrom}.done'
    output:
        png = 'data/plots/NA24385_prec_recall_{chrom}.png'
    run:
        ptf.plot_vcfeval(['data/NA24385/vcfeval/illumina_60x.filtered/{}'.format(wildcards.chrom),
                                   'data/NA24385/vcfeval/reaper.pacbio.ngmlr.20x.-z/{}'.format(wildcards.chrom),
                                   'data/NA24385/vcfeval/reaper.pacbio.ngmlr.30x.-z/{}'.format(wildcards.chrom),
                                   'data/NA24385/vcfeval/reaper.pacbio.ngmlr.40x.-z/{}'.format(wildcards.chrom),
                                   'data/NA24385/vcfeval/reaper.pacbio.ngmlr.50x.-z/{}'.format(wildcards.chrom),
                                   'data/NA24385/vcfeval/reaper.pacbio.ngmlr.69x.-z/{}'.format(wildcards.chrom),],
