...
rule plot_pr_curve_NA24149_hg38_Q30:
    params: job_name = 'plot_pr_curve_Q30_NA24149.hg38.{aligner}.{chrom}',
            title = None
    input: il34 = 'data/NA24149.hg38/vcfeval/freebayes.illumina.aligned.34x.filtered/{chrom}',
           pb32 = 'data/NA24149.hg38/vcfeval/longshot.pacbio.{aligner}.32x.-Q_30/{chrom}',
           il34_cov = 'data/NA24149.hg38/aligned_reads/illumina/illumina.aligned.all.34x.bam.median_coverage',
           pb32_cov = 'data/NA24149.hg38/aligned_reads/pacbio/pacbio.{aligner}.all.32x.bam.median_coverage'
    output: png = 'data/plots/Q30_NA24149.hg38.{aligner}.prec_recall_{chrom}.png'
    run:
        ptf.plot_vcfeval([input.il34, input.pb32],
                         ['Freebayes, Illumina {}x'.format(parse_int_file(input.il34_cov)),
