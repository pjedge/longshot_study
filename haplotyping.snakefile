...
rule extractHAIRS:
    ...
    input: bam = 'data/{individual}.{build}/aligned_reads/{tech}/{tech}.{aligner}.all.{rcov}x.split_chroms/{chrom}.bam',
           bai = 'data/{individual}.{build}/aligned_reads/{tech}/{tech}.{aligner}.all.{rcov}x.split_chroms/{chrom}.bam.bai',
           vcf = 'data/{individual}.{build}/variants/freebayes.illumina.aligned.{icov}x.haplotyping_filters/{chrom}.vcf',
