...
rule aj_trio_mendelian:
    ...
    input:  vcfgz = 'data/aj_trio/duplicated_regions/trio_shared_variant_sites/merged/{chrom}.gq30.vcf.gz',
            tbi = 'data/aj_trio/duplicated_regions/trio_shared_variant_sites/merged/{chrom}.gq30.vcf.gz.tbi',
            ped = 'aj-trio.ped',
...
# filter variants for aj trio individuals for positions that have at least 20x coverage in all 3 datasets
rule filter_trio_gq30:
    params: job_name = 'filter_trio_gq30.{chrom}'
    ...
    output: vcfgz = 'data/aj_trio/duplicated_regions/trio_shared_variant_sites/merged/{chrom}.gq30.vcf.gz'
    shell: '{RTGTOOLS} RTG_MEM=12g vcffilter --all-samples -g 30 -i {input.vcfgz} -o {output.vcfgz}'
...
rule filter_SNVs_gt_20_trio:
    ...
    input:  trio_bed = 'data/aj_trio/duplicated_regions/trio_covered_regions/{chrom}.cov_greater_than_20.trio_intersect.bed',
